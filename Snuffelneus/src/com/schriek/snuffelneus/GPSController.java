...
public class GPSController extends Thread {
	 ...
	 * Roept de timeoutableLocationListener aan, die de gps zoekt.
	 * Pakt ook de laatst bekende locaties gebaseerd op gps en netwerk en vergelijkt deze
	...
	public void run() {
		...
		listener = new TimeoutableLocationListener(locationManager, 60 * 1000,
				new TimeoutLisener() {
